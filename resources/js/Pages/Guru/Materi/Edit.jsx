...
export default function Edit({ materi, classrooms }) {
    const { data, setData, post, processing, errors } = useForm({
        class_id: materi.class_id?.toString() || '',
        title: materi.title || '',
    ...
    const handleSumbit = (e) => {
        ...
        post(route('guru.materies.update', materi.id), {
            forceFormData: true,
            onSuccess: () => {
                toast.success('Materi Berhasil diperbaharui');
            },
            onError: () => {
                toast.error('Gagal menambahkan materi', {
                    description: 'Pastikan semua form terisi dengan benar',
                });
            },
        });
    };
    return (
        <DashboardLayout>
            <Head title="Halaman Edit Materi" />
            <div className="min-h-screen pb-12">
                    ...
                    <div className="mt-6 flex flex-col justify-between gap-6 lg:flex-row lg:items-end">
                        <div className="space-y-1">
                            ...
                            <p className="text-muted-forground">
                                Perbarui materi yang berkualitas untuk
                        ...
                        <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
                            <Button
                                ...
                                disabled={processing}
                                className="h-12 w-full bg-primary px-10 font-bold shadow-xl shadow-primary/20 transition-all hover:scale-[1.02] hover:bg-primary/90 active:scale-[0.98] sm:w-auto"
                            >
                ...
                {/* Card */}
                <Card className="shadwo-slate-200/50 mx-4 overflow-hidden border-none shadow-2xl md:mx-6">
                            ...
                            <div className="space-y-8">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <Input
                                        ...
                                        className="h-auto border-none bg-transparent px-1 text-xl font-semibold placeholder:text-slate-400 focus-visible:ring-0 md:text-2xl"
                                        value={data.title}
                                        onChange={(e) =>
                                ...
                                <div className="space-y-2">
                                    ...
                                    <Textarea
                                        placeholder="Jelaskan yang akan di pelajari oleh siswa dengan narasi yang memotivasi dan mudah dimengerti"
                                ...
                                <div className="space-y-6">
                                    ...
                                    <div className="gird-cols-1 grid gap-4 sm:grid-cols-2">
                                        {[
                                            {
                                                id: 'video',
                                                label: 'Video Link',
